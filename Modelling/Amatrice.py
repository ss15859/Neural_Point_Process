...
#     M_test = M_test[M_test>=M0pred]
    ...
    # MLE = {'mu': 0.0355 /24, 'k0': 0.0936,'a':np.log(10),'c':0.01309*24,'omega':1.1842,'M0':3,'beta': np.log(10)}
    ...
    LLMLE = ETAS.likelihood(T_test,M_test,T_test[-1],M0pred,MLE)
...
# #     index = np.where(T_test>4000)[0][0]
    ...
    forcastN = npp1.daily_forecast(T_test,M_test,ndays=days,repeats=2,M0=Mcut,time_step=time_step,hours=24)
